using Games.Api.Extensions.Logs.Models;
...
namespace Games.Api.Extensions.Logs.Filter
{
    public class LogRequestActionFilter : IAsyncActionFilter
    {
        static readonly Serilog.ILogger Log = Serilog.Log.ForContext<LogRequestActionFilter>();
